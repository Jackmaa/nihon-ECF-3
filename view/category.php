...
<section class="hero_category">
    <div class="hero_category_txt">
        <h1><span>Shonen</span></h1>
        <p><span>The term shonen (少年) refers to a genre of manga and anime specifically aimed at young boys, usually aged 10 to 18. These works are appreciated for their ability to captivate a wide audience, beyond young boys, through universal and engaging stories.</span></p>
    </div>
</section>
<section class="manga_category">
    <div>
    <a href="<?php echo BASE_URL ?>manga/"><img src="<?php echo BASE_URL ?>public\asset\img\shonen\naruto.webp" alt="naruto">
        <figure>
