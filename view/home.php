...
<section>
    <?php foreach ($mangas as $category => $mangaList):
				            ...
				            <div class="slider-wrapper">
				                <?php foreach ($mangaList as $manga): ?>
				                    <div class="manga">
				                            ...
				                            <figure>
				                                <svg class="like-btn" data-manga-id="<?php echo $manga->getId_manga(); ?>" width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="slider">
                <div class="slider-wrapper">
                    <?php foreach ($manga as $manga): ?>
                        <div class="manga">
                            <a href="#"><img src="<?php echo $manga->getThumbnail() ?>" alt="<?php echo $manga->getName() ?>">
