...
<main class="la-page-manga">
        ...
        <div class="mangaPage-frst-section">
            ...
            <div class="summary-desktop">
                ...
                <div class="char-manga">
                    <div>
                    <?php
                        $categoriesArray = explode(",", $manga->categories); // Split the string into an array
                    ?>
                    <p>Category:</p>
                    <?php foreach ($categoriesArray as $category): ?>
                        <a href="<?php echo $this->router->generate("readCategory", ["category_name" => $category]) ?>"><?php echo htmlspecialchars(trim($category)); ?></a>
                    <?php endforeach; ?>
                    </div>
                    <div>
    ...
    <div class="mangaPage-scd-section">
        ...
        <form id="leave-review" method="post" action="/addrev/<?php echo $manga->manga->getId_manga(); ?>">
